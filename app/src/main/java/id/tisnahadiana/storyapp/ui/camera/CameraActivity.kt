package id.tisnahadiana.storyapp.ui.camera
...
import id.tisnahadiana.storyapp.databinding.ActivityCameraBinding
import id.tisnahadiana.storyapp.ui.post.PostActivity
import id.tisnahadiana.storyapp.utils.createFile
import java.io.File
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun setupButtons() {
        binding.btnCapture.setOnClickListener {
            if (photoTaken) {
                Toast.makeText(this, getString(R.string.wait_for_processing), Toast.LENGTH_SHORT)
                    .show()
            } else {
    ...
    private fun fromUriToFile(selectedImg: Uri, context: Context): File {
        ...
        val myFile = id.tisnahadiana.storyapp.utils.createTempFile(context)
